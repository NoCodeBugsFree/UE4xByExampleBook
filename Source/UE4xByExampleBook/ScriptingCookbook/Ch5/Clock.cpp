...
#include "ScriptingCookbook/Ch5/TimeOfDayHandler.h"
...
void AClock::BeginPlay()
{
	...
	{
		ATimeOfDayHandler* TimeOfDayHandler = Cast<ATimeOfDayHandler>(TimeOfDayHandlers[0]);
		
		MyDelegateHandle = TimeOfDayHandler->OnTimeChanged.AddUObject(this, &AClock::TimeChanged);

		// TimeOfDayHandler->OnTimeChanged.AddUObject(this, &AClock::TimeChanged);
	}
}
